...
- [ ] while (a = 0; a &lt; b; a++)<br>{<br>&nbsp;&nbsp;&nbsp;&nbsp;printf("%d\n", a);<br>}

- [ ] a = 0;<br>while (a &lt; b)<br>(<br>&nbsp;&nbsp;&nbsp;&nbsp;printf("%d\n", a);<br>&nbsp;&nbsp;&nbsp;&nbsp;a++;<br>)

- [x] a = 0;<br>do {<br>&nbsp;&nbsp;&nbsp;&nbsp;printf("%d\n", a);<br>&nbsp;&nbsp;&nbsp;&nbsp;a++;<br>}<br>while (a &lt; b);

- [x] a = 0;<br>while (a &lt; b)<br>&nbsp;&nbsp;&nbsp;&nbsp;printf("%d\n", a++);

- [x] a = 0;<br>while (a &lt; b)<br>{<br>&nbsp;&nbsp;&nbsp;&nbsp;printf("%d\n", a);<br>&nbsp;&nbsp;&nbsp;&nbsp;a++;<br>}

- [ ] a = 0;<br>do while (a &lt; b)<br>{<br>&nbsp;&nbsp;&nbsp;&nbsp;printf("%d\n", a);<br>&nbsp;&nbsp;&nbsp;&nbsp;a++;<br>}
